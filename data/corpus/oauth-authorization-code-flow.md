...
- Putting the user inside the client box. The user is a separate participant — the entire point of OAuth is that the user authenticates _outside_ the client.
